...
public class Register {
    ...
    public Register(String fName, String lName, String address, String userName, String password, String email, String phoneNo) {
        this.fName = fName;
        this.lName = lName;
        this.address = address;
        this.userName = userName;
        this.password = password;
        this.email = email;
        this.userId = 1; //Normally generated by the database
        this.phoneNo = phoneNo;
        try {
            this.salt = getSalt();
            hashPassword();
